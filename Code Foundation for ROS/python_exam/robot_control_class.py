...
class RobotControl():
    ...
    def publish_once_in_cmd_vel(self):
        ...
        while not self.ctrl_c:
            ...
            if connections > 0:
                ...
                #rospy.loginfo("Cmd Published") untuk kasih info di ubuntu
                break
            else:
                self.rate.sleep()
    ...
    def stop_robot(self):
        #rospy.loginfo("shutdown time! Stop the robot") untuk info di ubuntu
    ...
    def move_straight_time(self, motion, speed, time):
        ...
        # merubah kecepatan jadi 0 biar robot berhenti
        self.stop_robot()
